...
public class DataLoader {
	...
	CommandLineRunner baseLoad(EstudanteRepositorio repo) {
		...
		return args -> {
			...
			Estudante e1 = new Estudante("Marie Curie", new Date(Long.valueOf("-3223575624000")), 7 , endereco, mae);
			...
			Estudante e2 = new Estudante("Albert Einstein", new Date(Long.valueOf("-2865456000000")), 9 , endereco, mae);
			...
			Estudante e3 = new Estudante("Galileu Galilei", new Date(Long.valueOf("-12808281600000")), 8 , endereco, mae);
			
			endereco = new Endereco("57020-050", "Rua Cincinato Pinto", 265, 
					null, "Bairro do Centro", "Maceió", "AL");
			mae = new Mae("Maria Newton","476.588.560-70", datePay);
			Estudante e4 = new Estudante("Isaac Newton", new Date(Long.valueOf("-10319702400000")), 8 , endereco, mae);
			...
			Estudante e5 = new Estudante("Stephen William Hawking", new Date(Long.valueOf("-883008000000")), 6 , endereco, mae);
			...
			Estudante e6 = new Estudante("Niels Henrik David Bohr", new Date(Long.valueOf("-2654553600000")), 4 , endereco, mae);
			...
			Estudante e7 = new Estudante("Michael Faraday", new Date(Long.valueOf("-5625849600000")), 5 , endereco, mae);
			...
			Estudante e9 = new Estudante("Charles Robert Darwin", new Date(Long.valueOf("-5077036800000")), 2 , endereco, mae);
			...
			Estudante e10 = new Estudante("Augusta Ada Byron King", new Date(Long.valueOf("-4861728000000")), 1 , endereco, mae);
			...
			Estudante e11 = new Estudante("Nikola Tesla", new Date(Long.valueOf("-3581020800000")), 8 , endereco, mae);
			
			endereco = new Endereco("16074-160", "Rua Paraíso", 1738, 
					null, "Boa Vista", "Araçatuba", "SP");
			mae = new Mae("Maria Tesla","168.002.550-33", datePay);
			Estudante e12 = new Estudante("Cesare Mansueto Giulio Lattes", new Date(Long.valueOf("-1435104000000")), 2 , endereco, mae);
			...
			Estudante e13 = new Estudante("Francis Harry Compton Crick", new Date(Long.valueOf("-1690416000000")), 1 , endereco, mae);
			...
			Estudante e14 = new Estudante("Thomas Alva Edison", new Date(Long.valueOf("-3877977600000")), 5 , endereco, mae);			
			...
			Estudante e15 = new Estudante("Katherine Coleman Goble Johnson", new Date(Long.valueOf("-1620518400000")), 4 , endereco, mae);
			...
			Estudante e16 = new Estudante("James Dewey Watson", new Date(Long.valueOf("-1317168000000")), 7 , endereco, mae);
			...
			Estudante e17 = new Estudante("Charles Babbage", new Date(Long.valueOf("-5617641600000")), 6 , endereco, mae);
			...
			Estudante e18 = new Estudante("Dmitri Ivanovic Mendeleev", new Date(Long.valueOf("-4288464000000")), 5 , endereco, mae);
			...
			Estudante e19 = new Estudante("Carlos Ribeiro Justiniano das Chagas", new Date(Long.valueOf("-2855347200000")), 1 , endereco, mae);
			...
			Estudante e20 = new Estudante("Louis Pasteur", new Date(Long.valueOf("-4639334400000")), 2 , endereco, mae);
			...
			Estudante e21 = new Estudante("Antoine-Laurent de Lavoisier", new Date(Long.valueOf("-7142947200000")), 4 , endereco, mae);
			...
			Estudante e22 = new Estudante("Adolfo Lutz", new Date(Long.valueOf("-3598732800000")), 2 , endereco, mae);
			...
			Estudante e23 = new Estudante("Nicolau Copérnico", new Date(Long.valueOf("-15679526400000")), 7 , endereco, mae);
			
			endereco = new Endereco("69900-078", "Av. Brasil", 402, 
					null, "Centro", "Rio Branco", "AC");
			mae = new Mae("Maria Cruz","881.490.570-30", datePay);
			Estudante e24 = new Estudante("Oswaldo Gonçalves Cruz", new Date(Long.valueOf("-3073852800000")), 1 , endereco, mae);
			...
			Estudante e25 = new Estudante("Sigmund Schlomo Freud", new Date(Long.valueOf("-3586636800000")), 5 , endereco, mae);
